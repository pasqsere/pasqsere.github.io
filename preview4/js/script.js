(function($) {
    ...
    $('#clock').countdown('2018/06/29', function(event) {
    ...
    myform.submit(function(event){
      ...
      var template_id = "inviti";
      myform.find("button").text("Invio in corso...");
      emailjs.send(service_id, template_id,params)
        .then(function(){ 
           myform.find("button").text("Conferma");
           $("#success").show();
         }, function(err) {
